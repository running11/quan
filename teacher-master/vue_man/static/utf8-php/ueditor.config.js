...
(function () {
  ...
  var URL = window.UEDITOR_HOME_URL || getUEBasePath();
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: 'http://quan-dev.xiaoheiban.cn/api/upload/image'
        ...
        , toolbars: [[
          /*  'fullscreen', 'source', '|', 'undo', 'redo', '|',
            ...
            'undo', 'redo', '|',
           'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'removeformat', 'formatmatch', 'pasteplain', '|', 'selectall', 'cleardoc', '|',
           'fontfamily', 'fontsize', '|',
           'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|',
           'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
           'insertimage', 'emotion', 'scrawl', 'insertvideo', 'attachment'
        ]]
