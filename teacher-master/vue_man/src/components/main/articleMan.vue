    ...
    <div class="filter-con content">
      ...
      <div class="filter-content">
        <div class="fliter-wrapper">
          <div class="pull-left">
            ...
            <div class="condition-item date-select">
              <el-date-picker
                v-model="dataValue"
                type="daterange"
                align="right"
          ...
          <div class="filter-btn pull-left" @click="filter">筛选</div>
            <div class="dropdown right pull-right teacher-btn">
              <div class="dropdown-toggle" @click="addArticleType">新增文章</div>
              <div class="dropdown-menu add-article-type" :style="{display: displays}">
                <h4>请选择文章类型</h4>
                <ul>
                  <li class=" pull-left col-md-4" @click="addArticle('1')">
                    <img src="static/images/btn_picture.png" alt="">
                    <p>图文</p>
                  </li>
                  <li class=" pull-left col-md-4" @click="addArticle('3')">
                    <img src="static/images/btn_video.png" alt="">
                    <p>视频</p>
                  </li>
                  <li class=" pull-left col-md-4"  @click="addArticle('2')">
                    <img src="static/images/btn_voice.png" alt="">
                    <p>语音</p>
                  </li>
      ...
      <div class="article-top">
        ...
        <div class="pull-right">
          <el-select v-model="sortValue" placeholder="排序" class="sort-select" @change="sort" >
            <el-option
      ...
      <div class="article-list had-article">
					<div class="list" v-if="item.articles.rows.length>0" v-for="(items,index) in item.articles.rows" @click ="articleDetails(items.article_id, items.type)">
            <div class="list-wrapper">
              ...
              <div class="clearfix"></div>
					...
					<div class="page-num" v-if='item.articles.totals > 0'>
            <el-pagination
              background
  ...
  methods:{
    updata() {
      ...
      .then(res => {
        ...
        var data = res.data
        this.item.articles.rows = data.rows;
        this.item.articles.totals = data.totals
      })
    },
  	articleDetails(value1,value2){
  		//路由跳转
       this.$router.push({path:'/articleDetails',query:{article_id: value1, article_type: value2}})
  	},
    addArticleType(){
    ...
    addArticle(item){
       ...
       localStorage.removeItem('sourseOrgin');
    },
